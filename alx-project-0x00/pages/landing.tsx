      ...
      <div className="mt-4 space-y-4">
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <Button title="Small md" styles="text-sm rounded-lg" />
            <Button title="Small lg" styles="text-sm rounded-full" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <Button title="Medium md" styles="text-base rounded-lg" />
            <Button title="Medium lg" styles="text-base rounded-full" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="flex gap-3">
            ...
            <Button title="Large md" styles="text-lg rounded-lg" />
            <Button title="Large lg" styles="text-lg rounded-full" />
          </div>
        </div>
      </div>
    </div>
